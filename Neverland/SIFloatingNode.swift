...
open class SIFloatingNode: SKShapeNode {
    ...
    private func stateChanged() {
        ...
        case .selected:
            ...
            if let bubble = self as? BubbleNode {
                let labelNode = bubble.labelNode
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "ChangedSelectionToNewStar"), object: labelNode.text, userInfo: nil)
            }
        case .removing:
