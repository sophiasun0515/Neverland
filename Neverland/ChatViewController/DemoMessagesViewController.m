...
- (void)viewDidLoad
{
    ...
    if (!self.groupChatName) {
        self.groupChatName = @"Group Chat";
    }
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveMessagePressed:) name:@"ReceivedNewMessage" object:nil];
...
- (void)receiveMessagePressed:(id)sender
{
    if (![sender isKindOfClass:[NSNotification class]]) {
        NSLog(@"WE are not getting a notification, so passing here!");

        return;
    }
    
    NSLog(@"WE CARE: receivemessage pressed!");
    /**
     *  DEMO ONLY
     *
     ...
     */
    NSNotification* notif = sender;
    NSDictionary *messageDict = notif.userInfo;
    NSString *messageContent = [messageDict valueForKey:@"message"];
                      ...
                      date:(NSDate *)date
{
    ...
    JSQMessage *message = [[JSQMessage alloc] initWithSenderId:self.characterName
...
- (NSString *)senderId {
    if (!_senderId) {
        _senderId = kJSQDemoAvatarIdSquires;
    }
    return _senderId;
}
...
- (id<JSQMessageAvatarImageDataSource>)collectionView:(JSQMessagesCollectionView *)collectionView avatarImageDataForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (possibleAvatar != nil) {
        ...
        JSQMessagesAvatarImage *image = [avatarFactory avatarImageWithImage:possibleAvatar];
